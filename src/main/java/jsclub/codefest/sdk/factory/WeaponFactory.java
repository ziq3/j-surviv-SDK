...
public class WeaponFactory {
    ...
    private static final Map<String, Weapon> weaponMap = Map.ofEntries(
            ...
            Map.entry("BONE", new Weapon("BONE", ElementType.MELEE, 35, 45, 20, 2, 0, 20, 1, 0, AttackRange.SHORT, new Bullet(0, 0), null)),
            ...
            Map.entry("SHOTGUN", new Weapon("SHOTGUN", ElementType.GUN, 20, 20, 60, 4, 5, 60, 2, 0, AttackRange.LONG, new Bullet(40, 8), null)),
